---
name: ui-ux-pro-max
description: Generate UI/UX design-system guidance and implementation recommendations across multiple stacks. Use when the user asks to design, build, review, or improve UI/UX.
---
